...
### 级联回归
人脸对齐的定义是在图像上找到一组稀疏基准点，![集合](https://github.com/purity77/mdm-translation/blob/master/useimage/1.jpg).给出一个图形以及形状的初始估计，![集合](https://github.com/purity77/mdm-translation/blob/master/useimage/2.jpg).人脸对齐要求恢复到真实形状x*。例如SDM回归模型
